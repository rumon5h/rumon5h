...
- Have 4 + year's of hands-on experience in **Web and Mobile Applications Development**.
...
- 👨‍💻 Writing `React.js` `Next.js` `Node.js` `Express.js` `Tailwind CSS` `Material ui` `JavaScript` `TypeScript` `Java` `PHP` `React Native` `Redux`.
